...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-8">
                <h5 class="text-center">CERTIFICADO <br> PLAN VIDA/DESEMPLEO</h5>
            </div>
        ...
        <div class="row border">
            ...
            <table class="table table-borderless table-sm">
                <tbody>
                    ...
                    <tr>
                        <td style="width: 50%"><b>Cuota Mensual de Prestamo</b></td>
                        <td>RD${{ number_format($emision->getFieldValue('Cuota'), 2) }}</td>
                    </tr>
                    <tr>
