        ...
        <tbody>
            <?php foreach ((array)$emisiones as $emision) : ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= site_url("emisiones/plantillaincendio/" . $emision->getEntityId()) ?>" target="_blank" title="Descargar emisión">
                        ...
                        |
                        <a href="<?= site_url("emisiones/adjuntos/" . $emision->getFieldValue("Coberturas")->getEntityId()) ?>" title="Descargar documentos">
                        ...
                        |
                        <a href="<?= site_url("emisiones/documentos/" . $emision->getEntityId()) ?>" title="Adjuntar documentos">
